...
class ContentAdmin(admin.ModelAdmin):
    ...
    list_display = ('page', 'content_type', 'safe_linked_object', 'condition', 'order', 'always_available')
    list_editable = ('order',)
    readonly_fields = ('poster_base64', 'safe_linked_object')
    fields = ['page', 'order', 'content_type', 'object_id', 'condition', 'always_available', 'poster_base64', 'safe_linked_object']
